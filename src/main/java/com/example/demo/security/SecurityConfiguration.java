...
////                .antMatchers("/multirenter/create/product").permitAll()
//                .antMatchers("/v2/api-docs","/cubancoder/multirenter/**",
//                        "/configuration/ui",
//                        "/swagger-resources/**",
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .anyRequest().authenticated();
//        http.logout().logoutRequestMatcher(new AntPathRequestMatcher("/cubancoder/multirenter/logout"))
//                .invalidateHttpSession(true)
